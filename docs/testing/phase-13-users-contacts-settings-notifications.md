# Phase 13 Users/Roles + Contacts + Notifications Test Evidence
...
- Mobile handling in this phase:
  ...
  - role/invite/contacts/notifications flows remain active.
...
1. Open `/(protected)/management`.
   - Expected: screen renders tabs `Users`, `Contacts`, `Notifications`, `Access`.
2. Users tab:

...
## 1. Module Name
- Name: Users/Roles + Contacts + Notifications + Subscription Access
- Owner: Mobile
...
- Guard requirements: Protected route + `ModuleAccessGate`; route allows entry when any of users/contacts/notifications is menu-allowed or role-visible so subscription-locked tabs can still render upgrade UX.
